...
const increment = (clock, reset, timeValues) => {
...
const getIncrementType = (clock, timeValues) => {
    let type = '';
...
const decrement = (clock, reset, timeValues) => {
...
const getDecrementType = (clock, timeValues) => {
    let type = '';
    if (clock.hours > 0) {
        type = 'hours';
    }
...
const calculeTime = (timeValues, options = {
    isDecrement: false,
    reset: false
}) => {
    const { isDecrement, reset } = options;
    const { hours, mins, segs } = clock;
    if (timeValues !== undefined && (isDecrement !== null && isDecrement !== void 0 ? isDecrement : false)) {
        if (clock.hours === 0 && !clock.isDecrement)
            clock.hours = timeValues.hours;
        if (clock.mins === 0 && !clock.isDecrement)
            clock.mins = timeValues.mins;
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (calculeTime);
...
/* harmony import */ var _services_timer__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./services/timer */ "./src/services/timer.ts");
/* harmony import */ var _services_calculeTime__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./services/calculeTime */ "./src/services/calculeTime.ts");



const useReactTimer = ({ hours, mins, segs }) => {
    const h = `0${hours}`.slice(-2);
    const m = `0${mins}`.slice(-2);
    const s = `0${segs}`.slice(-2);
    const timeDefaultValue = `${h}:${m}:${s}`;
    const [time, setTime] = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(timeDefaultValue);
    const [timerActive, setTimerActive] = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(true);
    (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
        if (timerActive) {
            const timer = new _services_timer__WEBPACK_IMPORTED_MODULE_1__["default"](() => {
                const cT = (0,_services_calculeTime__WEBPACK_IMPORTED_MODULE_2__["default"])({ hours, mins, segs }, { isDecrement: true, reset: false });
                setTime(cT.time);
                if (cT.finish) {
                    timer.stop();
                }
    ...
    const handleResetClick = () => {
        ...
        handleStopClick();
        (0,_services_calculeTime__WEBPACK_IMPORTED_MODULE_2__["default"])(undefined, { reset: true });
    };
    return {
        handleStopClick,
        handleStartClick,
